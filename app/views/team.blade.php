...
<p class="img-feature"><img src="{{asset('images/team/team-1.jpg')}}" style="width:200px; height:195px" alt=""/></p>
<h2>Rehema Elikana </h2>
<h4>Chief Executive Officer (C.E.O)</h4>
<p>Rehema Elikana is the Independent Consultancy and C.E.O of SYoDeO, she is expert in human resource issue:- Recruiting & Selection; Training; Appraising; Entrepreneurship and business management  trainer; Researching  & Report Writing Expert.</p>
</div><!--end team-member-->
...
<div class="col-md-4 team-member">
<p class="img-feature"><img src="{{asset('images/team/team-2.jpg')}}" style="width:230px; height:195px" alt=""/></p>
...
<div class="col-md-4 team-member">
<p class="img-feature"><img src="{{asset('images/team/team-3.jpg')}}" style="width:200px; height:200px" alt=""/></p>
<h2>Innocent Augustine</h2>
<h4>Project Manager</h4>
<p>The project manager at SYoDeO, holding bachelor of Business Administration of University of Dar es Salaam Business School. He have been in microfinance industry for 12 years. 9 years working at FINCA and 2 years at Mtaji Credit Facility.<br>He enjoy working with youth with business ideas,guide them with entrepreneured skills and funding them to accomplish their goals.</p>
</div><!--end team-member-->
</div><!--end row-->

<div class="row">
<div class="col-md-6  faq-questions block-3col">
<h4 class="trigger"><a href="{{url('/')}}#q1">Our Policy</a></h4>
<div id="q1" class="toggle_container">
<p>SYoDeO Tanzania operates this website for the purposes of informing the public about our work and   other support provided. The copyright in this website as a whole and in the text contained in this website are owned by SYoDeO Tanzania. None of the text, copy, or graphics in this website may be reproduced in whole or in part (except for information clearly taken from the public domain) without the express prior written permission of SYoDeO Tanzania.</p>
<p>SYoDeO values your support and is committed to protecting your privacy. This statement addresses concerns visitors to our site may have about the information they provide to us, and how we treat that information.</p>
</div>
...
<div id="q3" class="toggle_container">
<p>Materials provided on this Site are provided “as is”, without warranty of any kind, either express or implied, including, without limitation, warranties of merchantability, fitness for a particular purpose and non-infringement. The SYoDeO  specifically does not make any warranties or representations as to the accuracy or completeness of any such Materials. The SYoDeO periodically adds, changes, improves or updates the Materials on this Site without notice. Under no circumstances shall the SYoDeO be liable for any loss, damage, liability or expense incurred or suffered that is claimed to have resulted from the use of this Site, including, without limitation, any fault, error, omission, interruption or delay with respect thereto. The use of this Site is at the User’s sole risk. Under no circumstances, including but not limited to negligence, shall the SYoDeO or its affiliates be liable for any direct, indirect, incidental, special or consequential damages, even if the SYoDeO has been advised of the possibility of such damages.</p>
<p>The User specifically acknowledges and agrees that the SYoDeO  is not liable for any conduct of any User.</p>
<p>This site may contain advice, opinions and statements of various information providers. The SYoDeO does not represent or endorse the accuracy or reliability of any advice, opinion, statement or other information provided by any information provider, any User of this Site or any other person or entity. Reliance upon any such advice, opinion, statement, or other information shall also be at the User’s own risk. Neither the SYoDeO, nor any of their respective agents, employees, information providers or content providers, shall be liable to any User or anyone else for any inaccuracy, error, omission, interruption, deletion, defect, alteration of or use of any content herein, or for its timeliness or completeness, nor shall they be liable for any failure of performance, computer virus or communication line failure, regardless of cause, or for any damages resulting therefrom.If this Site contains bulletin boards, chat rooms, access to mailing lists or other message or communication facilities, the User agrees to use them only to send and receive messages and materials that are proper and related to the particular facilities. By way of example and not as a limitation, the User agrees that when using a above mention facilities, he or she shall not do any of the following: </p>
